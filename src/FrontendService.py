...
ChatGPT has been created with one main objective ‚Äto predict the next word in a sentence, based on what's typically happened in the gigabytes of text data that it's been trained on.
ChatGPT was released as a "research preview" on November 30, 2022. A blog post (opens in new tab) casually introduced the AI chatbot to the world, with OpenAI stating that "we‚Äôve trained a model called ChatGPT which interacts in a conversational way".
ChatGPT Plus costs $20 p/month (around ¬£17 / AU$30) and brings a few benefits over the free tier. It promises to give you full access to ChatGPT even during peak times, which is when you'll otherwise frequently see "ChatGPT is at capacity right now‚Ämessages during down times.
